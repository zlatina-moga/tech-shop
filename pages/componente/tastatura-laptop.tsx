...
const LaptopKeyboards = () => {
  ...
  useEffect(() => {
    if (priceRange != '' && brand && selectedSort != "/componente/tastatura-laptop") {
    ...
    } else if (priceRange != '' && !brand  && selectedSort != "/componente/tastatura-laptop") {
      const sort = selectedSort.split("=")[1];
      productService
      ...
      const sort = selectedSort.split("=")[1];
      productService
        .getSortedLaptopKeyboards(currentPage, sort)
        .then((result) => {
          setLoading(false);
          setLaptopsData(result);
        })
...
export default LaptopKeyboards;
