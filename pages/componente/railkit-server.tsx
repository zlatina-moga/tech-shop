...
const Railkits = () => {
  ...
  const [selectedSort, setSelectedSort] = useState("/componente/railkit-server");
  ...
  useEffect(() => {
    ...
    sortingService.getHighestPrice(84).then((response) => {
  ...
  useEffect(() => {
    ...
    productService
      .getSortedRailkit(currentPage, sort)
      .then((result) => {
        setLoading(false);
        setLaptopsData(result);
      })
