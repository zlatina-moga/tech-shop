...
const DataProcessing = () => {
  return (
    <>
      <Navbar />
      <Meta title="Prelucrarea datelor" />
      <div
      ...
      >
        <div className="text-center mb-4">
          ...
          <p>
            ...
            de muncă, are la bază ca standard de calitate protecția drepturilor
            la viață privată și la prelucrarea datelor cu caracter personal.
          </p>
          <br />
          <p>
        ...
        <div className="text-start mb-1">
          ...
          <p>
            ...
            persoane fizice care interacționează cu compania și/sau sunt
            antrenate în relații contractuale.
          </p>
          <p>
        ...
        <div className="text-start mb-1">
          ...
          <p>
            ...
            partajate cu companiile de curierat: ex Fan Courier, GLS General
