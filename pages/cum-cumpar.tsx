...
const data: IData[] = [
  ...
  },
  {
    ...
    description: [
      ...
      "Nu este perceput nici un comision suplimentar pentru tranzactii. Pentru asigurarea securitatii tranzactiilor, Exclusive Key Licenses SRL foloseste sistemul Netopia payments. Pentru finalizarea corecta a tranzactiei, trebuie sa furnizezi codul cardului (toate cifrele din cele patru grupe de pe fata cardului, fara spatii), data de expirare si ultimele trei cifre de pe spatele cardului inscriptionate pe banda cu semnatura ta. Indiferent de valuta pe care o ai in cont, tranzactiile se fac in lei la cursul de schimb al bancii unde este emis cardul. Procesarea datelor de card se face in mod exclusiv pe serverele Netopia payments, Exclusive Key Licenses SRL nu solicita si nu stocheaza nici un fel de detalii referitoare la card.",
    ],
  },
