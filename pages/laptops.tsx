      ...
      <div className="row px-xl-5 pb-3 justify-content-center">
        {laptopsData.map((l, idx) => (
          ...
          >
            ...
            >
                <div className={classNames("card-header product-img position-relative overflow-hidden bg-transparent", 'img-wrapper')}>
                  <Image className="img-fluid w-100" src={l.images[0]} alt="" />
                </div>
                <div className="card-body text-center p-0 pt-4 pb-3">
                  <h6 className="text-truncate mb-3">{l.title}</h6>
