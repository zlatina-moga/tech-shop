  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <SingleDetailedView itemData={itemData} breadcrumbs={workstationSHBrcrmbs} techSpecs={techDetails} upgradeOptions={productDetails[40]} warrantyOptions={productDetails[24]} />
      )}
      <Footer />
    </>
  );
