...
const BrandDetail = () => {
  ...
  useEffect(() => {
    if (priceRange != '' && procesor  && selectedSort != `/servere/nou/brand/${slug}`) {
      setShow(false);
    ...
    } else if (priceRange != '' && !procesor && selectedSort != `/servere/nou/brand/${slug}`) {
      setShow(false);
    ...
    } else if (procesor && selectedSort != `/servere/nou/brand/${slug}`) {
      setShow(false);
    ...
    } else if (selectedSort != `/servere/nou/brand/${slug}`) {
      router.push(selectedSort);
      const sort = selectedSort.split("=")[1];
      setShow(false);
      productService
