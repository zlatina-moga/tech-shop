...
const NewPrinters = () => {
  ...
  useEffect(() => {
    productService
      .getAllPrinterCollateral(currentPage)
      .then((result) => {
        setLoading(false);
  ...
  useEffect(() => {
    if (priceRange != '' && selectedSort != "/imprimante/consumabile") {
      setShow(false);
    ...
    } else if (selectedSort != "/imprimante/consumabile")  {
