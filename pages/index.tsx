            ...
            <div className="col-lg-3 d-none d-lg-block" >
              ...
              >
                <div
                  ...
                  style={{ height: 410, borderBottomLeftRadius: '4px', borderBottomRightRadius: '4px' }}
                >
                  ...
                  <a href="" className="nav-item nav-link py-3" style={{borderBottom: 'none'}}>
                    Components
                  </a>
                </div>
              </nav>
        ...
        <div className="container-fluid pt-5">
          <div className="row px-xl-5 pb-3">
            <div className="col-lg-4 col-md-6 pb-1">
              ...
              >
                <p className="text-right">152 Products</p>
                <a
                  href="/laptops"
