  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <SingleDetailedView itemData={itemData} breadcrumbs={newComputersBrcrmbs} techSpecs={techDetails} upgradeOptions={productDetails[40]} warrantyOptions={productDetails[24]} />
      }
      <Footer />
    </>
  );
