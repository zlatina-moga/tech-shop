...
const SecondHandCompDetails = () => {
  ...
  return (
    <>
      ...
      {loading ? (
        <DetailPageSkeleton />
      ) : <SingleDetailedView itemData={itemData} breadcrumbs={secondHandComputersBrcrmbs} techSpecs={techDetails} upgradeOptions={productDetails[40]} warrantyOptions={productDetails[24]} />}
      <Footer />
    </>
  );
};
